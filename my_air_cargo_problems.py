...
class AirCargoProblem(Problem):
            ...
            for cargo in self.cargos:
                for plane in self.planes:
                    for airport in self.airports:
                            ...
                            load = Action(expr("Load(%s, %s, %s)" % (cargo, plane, airport)), \
            ...
            for cargo in self.cargos:
                for plane in self.planes:
                    for airport in self.airports:
                            ...
                            unload = Action(expr("Unload(%s, %s, %s)" % (cargo, plane, airport)), \
                                [precond_pos, precond_neg], [effect_add, effect_rem])
    ...
    def actions(self, state: str) -> list:
        ...
        for action in self.actions_list:
            ...
            # Positive preconditions are carried out
            for clause in action.precond_pos:
                if clause not in knowledge_base.clauses:
                    is_possible = False
                    break

            # Negative preconditions are carried out
